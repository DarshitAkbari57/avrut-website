                ...
                <div className="mx-auto flex container items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
                    <Link href='/home'>
                        <div className="inline-flex items-center space-x-2">
                            <img className='w-[130px] h-[80px] object-cover' src="/images/assets/logo2.png" alt="" />
                        </div>
                    </Link>
                    <div className="hidden lg:flex">
                        <ul className="ml-12 inline-flex space-x-8">
                            {menuItems.map((item) => (
                                <>
                                    <li className={item?.path ? "py-4" : "py-4 group"} key={item.name}>
                                        <a
                                            ...
                                            }
                                            {
                                                ...
                                                <div className="h-full">
                                                    <div className='flex  h-full justify-between'>
                                                        ...
                                                        <div className='h-full w-full px-10 '>
                                                            <div className='grid grid-cols-3 '>
                                                                <div className='flex p-5 flex-col hover:bg-purple cursor-pointer' onClick={() => router.push('/services/digital-product-design')}>
                                                                    <h1 className='font-semibold'>Digital Product Design</h1>
                                                                    <div className='flex gap-4 mt-2'>
                                                                        <ul className=''>
                                                                ...
                                                                <div className='flex p-5 flex-col hover:bg-purple cursor-pointer' onClick={() => router.push('/services/software-architecture')}>
                                                                    <h1 className='font-semibold'>Software Architecture</h1>
                                                                    <div className='flex gap-4 mt-2'>
                                                                        <ul>
                                                                            <li className='cursor-pointer text-[14px] pb-2 text-gray1' onClick={() => router.push('/technology/anguler')} >
                                                                                Architects create scalable software solution with modularity and core strength
                                                                            </li>
                                                                ...
                                                                <div className='flex p-5 flex-col hover:bg-purple cursor-pointer' onClick={() => router.push('/industries/e-commerce')}>
                                                                    <h1 className='font-semibold'>Engineering &  DevOps</h1>
                                                                    <div className='flex gap-4 mt-2'>
                                                                        <ul>
                                                                            <li className='cursor-pointer text-[14px] pb-2 text-gray1' onClick={() => router.push('/technology/docker')} >
                                                                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque consequuntur mollitia sunt cum
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                <div className='flex p-5 flex-col hover:bg-purple cursor-pointer' onClick={() => router.push('/industries/digital-banking')}>
                                                                ...
                                                                <div className='flex p-5 flex-col hover:bg-purple cursor-pointer' onClick={() => router.push('/industries/entertainment')}>
                                                    ...
                                                    <div className='flex  h-full justify-between'>
                                                        ...
                                                        <div className='h-full w-full px-10 '>
                                                            <div className='grid grid-cols-3 '>
                                                                ...
                                                                <div className='flex p-5 flex-col hover:bg-purple cursor-pointer' onClick={() => router.push('/industries/education')}>
                            ...
                            <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 h-screen">
                                <div className="px-5 pb-6 pt-5">
                                    <div className="flex items-center justify-between">
                                        <div className="inline-flex items-center space-x-2">
                                            <img className='h-10 w-10' src="images/assets/logo1.png" alt="" />
                                        </div>
                                        <div className="-mr-2">
                                            <button
                                                type="button"
