...
import { MdMiscellaneousServices, MdOutlineMiscellaneousServices, MdOutlineUpload } from "react-icons/md";
    ...
    return (
        <>
            ...
            <p className='text-[#777] text-xl text-center font-medium  max-w-3xl m-auto'>
                Avrut Solutions offers full-cycle software development services that effortlessly adapt to the needs of your project and business.
            </p>
                    ...
                    return (
                        <>
                            <div className='bg-gray-200 w-full h-[300px] flex justify-center items-center font-semibold rounded-xl text-xl  flex-col'>
                                <div className='my-3 text-4xl md:text-6xl text-primary' >{e?.icon}</div>
