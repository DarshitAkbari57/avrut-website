    ...
    return (
        <>
            ...
            <footer className="text-black dark:text-white  body-font">
                <div className=" px-5 sm:px-5 md:px-10 lg:px-10 xl:px-10 2xl:px-10 lg:py-24 py-10 ">
                    <div className="flex flex-wrap md:text-left text-center order-first">
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                            ...
                            <div className=" mb-10 flex lg:justify-start md:justify-start  justify-center">
                                <Link to='/' className='mx-2' onClick={handleClick}>Home</Link>
                                <Link to='/about' className='mx-2' onClick={handleClick}>About</Link>
                                <Link to='/service' className='mx-2' onClick={handleClick}>Service</Link>
                                <Link to='/getintouch' className='mx-2' onClick={handleClick}>Contact</Link>
                                <Link to='/careear' className='mx-2' onClick={handleClick}>Career</Link>
