...
function Hero() {
    ...
    return (
        ...
        <>
            ...
            <div id='myElement' className='overflow-y-hidden container mx-auto py-8' >
                <div className="px-5 sm:px-5 md:px-10 lg:px-10 xl:px-10 2xl:px-10 animation" data-aos="fade-up">
                    <div className="flex flex-col lg:text-start text-center w-full mt-10 sm:mt-20 lg:ml-3 ">
                        ...
                        <h1 className="text-lg  text-center m-auto mb-4 text-black dark:text-white  lg:w-[60%] mt-4">We Are Bunch Of Creative Professional Nerds. We've Been Helping Companies Make Or Save Money With Their Products By Providing Visions And Technical Solution With Innovative Design And Devlopment.</h1>
                    </div>
                </div>
            ...
            <div className="px-5 sm:px-5 md:px-10 lg:px-10 xl:px-10 2xl:px-10 animation my-5" data-aos="fade-up">
                <div className="flex flex-col  text-center w-full  lg:ml-3 ">
                    ...
                    <p className="text-lg text-center mt-4 mb-4 text-gray-900 dark:text-white lg:w-[60%] m-auto">
