...
function Culture() {
    ...
    return (
        <>
            ...
            <div className=" px-5 sm:px-5 md:px-10 lg:px-10 xl:px-10 2xl:px-10 grid lg:grid-cols-2   sm:grid-cols-1 mt-10  place-items-center overflow-x-hidden w-full container mx-auto">
